    ...
    <main className="min-h-screen">
      ...
      <div className="bg-white">
        <div className="relative isolate px-6 py-16 sm:py-24 lg:py-32 lg:px-8 overflow-hidden">
          ...
          >
            <div 
              className="relative left-[calc(50%-11rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 rotate-[30deg] bg-gradient-to-tr from-slate-100 to-slate-300 opacity-30 sm:left-[calc(50%-30rem)] sm:w-[72.1875rem]" 
            ...
            <div className="text-center">
              ...
              <div className="mt-10 flex items-center justify-center gap-x-6">
                <SignUpButton mode="modal">
                  <button className="rounded-md bg-slate-800 px-4 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-slate-900 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-slate-800 transition-all">
                    Start Your Collection
                  </button>
                </SignUpButton>
                <a href="#how-it-works" className="text-sm font-semibold leading-6 text-slate-900 hover:text-blue-600 transition-colors">
          ...
          >
            <div 
              className="relative left-[calc(50%+3rem)] aspect-[1155/678] w-[36.125rem] -translate-x-1/2 bg-gradient-to-tr from-slate-200 to-blue-100 opacity-20 sm:left-[calc(50%+36rem)] sm:w-[72.1875rem]" 
              style={{ clipPath: 'polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)' }}
            />
          </div>
        </div>
      ...
      <div className="bg-white py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            <h2 className="text-base font-semibold leading-7 text-blue-600">Perfect For Any Occasion</h2>
            <p className="mt-2 text-3xl font-bold tracking-tight text-slate-900 sm:text-4xl">
          ...
          <div className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:mt-20 sm:grid-cols-2 lg:mx-0 lg:max-w-none lg:grid-cols-3">
            {[
              ...
              <div key={index} className="flex flex-col items-start">
                <h3 className="text-lg font-semibold leading-8 tracking-tight text-slate-900">{occasion.title}</h3>
                <p className="mt-1 text-base leading-7 text-slate-600">{occasion.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="bg-slate-50 py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="mx-auto mt-16 flow-root max-w-2xl lg:max-w-4xl">
            <div className="rounded-2xl bg-white p-8 shadow-sm ring-1 ring-slate-200 luxury-shadow">
              ...
              <div className="mt-6 flex items-center gap-x-4">
                <div>
                  ...
                  <p className="text-sm leading-6 text-slate-600">Mother of a College Graduate</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="bg-white">
        <div className="mx-auto max-w-7xl py-24 sm:px-6 sm:py-32 lg:px-8">
          <div className="relative isolate overflow-hidden bg-slate-900 px-6 py-24 text-center shadow-2xl sm:rounded-3xl sm:px-16 luxury-shadow">
            ...
            <div className="mt-10 flex items-center justify-center gap-x-6">
              <SignUpButton mode="modal">
                <button className="rounded-md bg-white px-4 py-2.5 text-sm font-semibold text-slate-900 shadow-sm hover:bg-slate-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white transition-all">
                  Get Started
                </button>
              </SignUpButton>
            </div>
            <div className="absolute -top-24 right-0 -z-10 transform-gpu blur-3xl" aria-hidden="true">
              <div className="aspect-[1404/767] w-[87.75rem] bg-gradient-to-r from-slate-800 to-slate-700 opacity-30" style={{ clipPath: 'polygon(73.6% 51.7%, 91.7% 11.8%, 100% 46.4%, 97.4% 82.2%, 92.5% 84.9%, 75.7% 64%, 55.3% 47.5%, 46.5% 49.4%, 45% 62.9%, 50.3% 87.2%, 21.3% 64.1%, 0.1% 100%, 5.4% 51.1%, 21.4% 63.9%, 58.9% 0.2%, 73.6% 51.7%)' }} />
            </div>
          </div>
        </div>
      </div>
